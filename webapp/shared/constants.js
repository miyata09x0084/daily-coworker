...
/** 兄の調子（記録者から見た様子）。1 = しんどそう 〜 5 = 調子よさそう */
export const CONDITIONS = [
  { value: 1, label: 'かなりしんどそう' },
  { value: 2, label: 'しんどそう' },
  { value: 3, label: 'ふつう' },
  { value: 4, label: '落ち着いている' },
  { value: 5, label: '調子よさそう' },
];
...
/** かみ合わなさ。低い処理速度に対して急かした日を後から見つけるために残す */
export const FRICTIONS = [
  { key: 'none', label: 'すんなり通った' },
  { key: 'some', label: '少しかみ合わなかった' },
  { key: 'hard', label: '話が止まった・こじれた' },
];
